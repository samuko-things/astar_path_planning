...
show_animation = True  # change to false if you dont want the a_star plot to display
...
class AStarPlanner:
    ...
    def planning(self, sx, sy, gx, gy):
        ...
        input:
            s_x: start x grid position
            s_y: start y grid position
            gx: goal x grid position
            gy: goal y grid position

        output:
            rx: x position list of the final path grid positions
